...
// Mudar Aqui o e-mail
$email_envio = 'contato@diegoalves.design'; // E-mail do site (ex: contato@seusite.com)
$email_pass = '88262551diego.'; // Senha do e-mail

$site_name = 'Diego Alves Design'; // Nome do Site
$site_url = 'www.diegoalves.design'; // URL do Site

$host_smtp = 'smtpout.secureserver.net'; // HOST SMTP Ex: smtp.domain.com.br
  ...
  <html>
    ...
    <body>
      ...
      <div class="form-content" id="form-erro">
        ...
        <p>Você pode tentar novamente ou enviar direto para: contato@diegoalves.design <?php echo $email_envio; ?></p>
      </div>
    </body>
  </html>
